...
// GetRawResp mocks base method
func (m *MockResponse) GetRawResp() *http.Response {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRawResp")
	ret0, _ := ret[0].(*http.Response)
	return ret0
}

// GetRawResp indicates an expected call of GetRawResp
func (mr *MockResponseMockRecorder) GetRawResp() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetRawResp", reflect.TypeOf((*MockResponse)(nil).GetRawResp))
}
