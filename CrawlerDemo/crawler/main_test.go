...
func TestMP4(t *testing.T) {
	...
	// u, _ := url.Parse("https://www.ssetech.com.cn/place/redirect.do?id=101")
	// req := &http.Request{
	// 	Method: "GET",
	// 	URL:    u,
	// }

	resp, err := c.Get("https://www.ssetech.com.cn/place/redirect.do?id=101")
	if err != nil {
		t.Fatal(err)
	}
	...
	if err := htmlutil.WriteToFile("test.html", body); err != nil {
		t.Fatal(err)
	}
}
